function findRecipe() {
    ...
    if (typeof recipes === 'undefined') {
        ...
        console.error("recipes değişkeni tanımlı değil.");
        return;
    }
    ...
    const matchingRecipes = recipes.filter(recipe => {
        // Tarifin malzemelerinden en az biri kullanıcı girdisinde varsa eşleşme kabul edilir
        return recipe.ingredients.some(ingredient => ingredientsList.includes(ingredient));
    });
